...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = (User) getIntent().getSerializableExtra(ProfileEditActivity.EXTRA_KEY_USER);
...
//        Disposable disposable = viewModel.getProgressDialogVisibility().subscribeOn(AndroidSchedulers.mainThread())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(shouldShowLoading -> {
//                    binding.progressBarProfileEditActivityLoading.setVisibility(shouldShowLoading ? View.VISIBLE : View.GONE);
//                    binding.btnProfileEditActivityEdit.setVisibility(shouldShowLoading ? View.GONE : View.VISIBLE);
//                });
